...
class update_79 extends database
{
    ...
    public function run()
    {
        ...
        self::clearDate();
        self::defaultDate();
        self::setRolesPermissions();
        self::setMemberPermissions();
    }
     ...
     * @param string $action
     */
    private function updataLogs($action = '')
    {
    ...
    {
        global $_M;
        self::updataLogs('setRolesPermissions');
...
//            dump($sql);
     ...
     * @return mixed
     */
    private function permissionsFunc()
    {
        global $_M;
     ...
     * @return array
     */
    private function permissionsMenus()
    {
        global $_M;
