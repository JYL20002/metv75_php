      ...
      <dd class="form-group clearfix" data-plugin="checkAll">
        <div class="custom-control custom-checkbox ">
          <input type="checkbox" id="langok_1" name="langok" value="metinfo"
            class="custom-control-input lang-select-all checkall-all" data-delimiter="-" checked="checked" disabled="disabled" />
        ...
        <list data="$_M['langlist']['web']" name="$lang">
          <div class="custom-control custom-checkbox ">
            <input type="checkbox" id="checkbox-{$lang.lang}" name="langok" value="{$lang.lang}" data-delimiter="-"
              class="custom-control-input lang-select-item checkall-item" checked="checked" disabled="disabled" />
