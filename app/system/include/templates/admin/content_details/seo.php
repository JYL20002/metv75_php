...
?>
<h3 class='example-title clearfix'><span class="my-1 d-inline-block" role="button" data-toggle="collapse" data-target=".{$data.n}-details-seo">SEO {$word.seting}<i class="icon fa-angle-right ml-2"></i></span></h3>
